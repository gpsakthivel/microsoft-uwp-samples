...
namespace bold_reports_uwp_report_writer
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (savedItem != null)
            {
                ...
                Stream reportStream = assembly.GetManifestResourceStream("bold_reports_uwp_report_writer.Resources.Table_Summaries.rdlc");
